...
export default function Categories() {
  ...
  return (
    <div className={`min-h-screen pt-24 pb-16 colorful-gradient-bg ${dark ? 'text-white' : 'text-gray-900'}`}>
            ...
            return (
              <div key={cat.id} className={`card-modern group ${dark ? 'bg-near-black/60 border-white/10' : 'bg-white shadow-2xl shadow-black/5'}`}>
                ...
                <div className="p-8">
                  ...
                  <p className={`text-sm leading-relaxed mb-6 h-10 overflow-hidden ${dark ? 'text-gray-400' : 'text-gray-500'}`}>
                    {cat.description}
                  </p>
                  <div className="mb-8">
                  ...
                  <Link to="/donate" className={`modern-link group/link ${dark ? 'text-white hover:text-brand' : 'text-near-black hover:text-brand'}`}>
