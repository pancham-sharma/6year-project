    ...
    <header className={`flex items-center justify-between px-4 lg:px-6 py-3.5 border-b ${bg} sticky top-0 z-30`}>
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          <div className={`hidden sm:flex items-center gap-2 px-3 py-2 rounded-xl border text-sm ${inputBg} w-64 focus-within:shadow-lg focus-within:border-green-500/50 transition-all duration-300 ease-in-out`}>
